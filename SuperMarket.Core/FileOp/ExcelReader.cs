...
namespace SuperMarket.Core.FileOp
{
	...
	public class ExcelReader : IDisposable
	{
		...
		private string ExcelConnection()
		{
            ...
            @"Provider=Microsoft.ACE.OLEDB.12.0;Password=;User ID=;Data Source=" + _strExcelFilename + ";" +
             @"Mode=Share Deny Write;Extended Properties='" + ExcelConnectionOptions() + "';Jet OLEDB:Engine Type=37";
		}
		#endregion
