...
namespace SuperMarket.Pay.WeiXin
{
    public class JsApiPay
    {
	    ...
	    */
        public void GetOpenidAndAccessTokenFromCode(string code)
        {
            try
            {
               ...
               WxLog.Debug(this.GetType().ToString(), "GetOpenidAndAccessTokenFromCode response : " + result);
               ...
               WxLog.Debug(this.GetType().ToString(), "Get openid : " + openid);
               WxLog.Debug(this.GetType().ToString(), "Get access_token : " + access_token);
            }
            catch (Exception ex)
            {
               WxLog.Error(this.GetType().ToString(), ex.ToString());
        ...
        */
        ...
        {
           WxLog.Debug(this.GetType().ToString(), "JsApiPay::GetJsApiParam is processing...");
           ...
           WxLog.Debug(this.GetType().ToString(), "Get jsApiParam : " + parameters);
            return parameters;
        }
