...
namespace SuperMarket.Pay.WeiXin
{
    ...
    /// </summary>
    public class NativeNotify:WxNotify
    {
        ...
        public override void ProcessNotify()
        {
            ...
            if (!notifyData.IsSet("openid") || !notifyData.IsSet("product_id"))
            {
               ...
               WxLog.Info(this.GetType().ToString(), "The data WeChat post is error : " + res.ToXml());
                return;
            }
            ...
            catch(Exception ex)//若在调统一下单接口时抛异常，立即返回结果给微信支付后台
            {
               ...
               WxLog.Error(this.GetType().ToString(), "UnifiedOrder failure : " + res.ToXml());
                return;
            }
           ...
           WxLog.Info(this.GetType().ToString(), "UnifiedOrder success , send data to WeChat : " + data.ToXml());
            return;
        }
